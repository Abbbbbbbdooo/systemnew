...
client.on('message', message => {
  ...
  if (message.author.id !== "394408399812427776") return;
...
if (message.content === '$inv') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=517828645117755399&permissions=0&scope=bot').catch(e => console.log(e.stack));
